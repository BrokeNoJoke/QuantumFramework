...
-- coming soon --
-- RegisterNetEvent('NAT2K15:MAKETHEMUGSHOT')
-- AddEventHandler('NAT2K15:MAKETHEMUGSHOT', function(id, name, gender, dob) 
...
--   TriggerServerEvent('NAT2K15:MUGSHOTCREATED', id, name, gender, dob, headshot)
--   Citizen.Wait(2000)
